...
//        System.out.println(list.size());
    ...
    public void insertOrder(){
        ...
        String sql = "INSERT INTO itcast_shop.itcast_orders (orderNo,userId,goodsMoney,totalMoney,areaId,userName,userAddress,orderunique,createTime,payTime,isFromCart,platform) VALUES(123456,20,'0.12','0.12','123','徐牧','江苏省 无锡市 北塘区','8021250f-0e82-48dd-bc23-d9cb2908bfc0',?,?,?,?)";
        ...
        try {
            ...
            for(int i=0;i<1;i++){
                ...
                ps.setString(1, createDateString);
                ps.setString(2, payDateString);
                ps.setInt(3, random.nextInt(2));
                ps.setInt(4, random.nextInt(6));
                ps.execute();
